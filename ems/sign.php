	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="db.php" method="post">
					<span class="login100-form-title">
						Member Signup
					</span>
					
					<div class="text-center p-t-10 vert-offset-bottom-0">
					<span class="txt1">
							<?php echo $msg; ?>
					</span>
					</div>
					...
					<div class="wrap-input100 " >
						<div class="input-group input100">
                                    <div> Select Role</div>
                                    <div class="p-t-5">
                                        <label class="radio-container m-r-45">Proffessor
                                            <input type="radio" checked="checked" name="role" value="prof">
